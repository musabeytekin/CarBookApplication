...
public class CarBookContextDesignFactory : IDesignTimeDbContextFactory<CarBookContext>
{
    
    public CarBookContext CreateDbContext(string[] args)
    {
        var optionsBuilder = new DbContextOptionsBuilder<CarBookContext>()
            .UseSqlServer("Server=localhost; Database=CarBook; User=sa; Password=Password12*; TrustServerCertificate=True;");
